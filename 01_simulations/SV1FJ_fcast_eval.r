...
filename <- paste0("fcasts_", Symbol, "_M", M, "_lam", lam, "_sig", sig, "_alpha", alphav, ".rds")
...
filename <- paste0("DMW_results_individual_", Symbol, "_M", M, "_lam", lam, "_sig", sig, "_alpha", alphav, ".rds")
